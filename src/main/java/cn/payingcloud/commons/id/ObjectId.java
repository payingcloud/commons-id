 ...
 *
 * @mongodb.driver.manual core/object-id MongoId
 */
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    /**
     * <p>Creates an MongoId using time, machine and inc values.  The Java driver used to create all MongoIds this way, but it does not
     * match the <a href="http://docs.mongodb.org/manual/reference/object-id/">MongoId specification</a>, which requires four values, not
     ...
     * <p>
     * <p>NOTE: This will not break any application that use MongoIds.  The 12-byte representation will be round-trippable from old to new
     * driver releases.</p>
     *
     * @param time    time in seconds
     * @param machine machine ID
     * @param inc     incremental value
     * @return a new {@code MongoId} created from the given values
     * @since 2.12.0
     */
